...
export const InfoBoard = ({ chars, timeElapsed, imgName, won }) => {
  ...
  return (
    <div className="infoBoard">
      <div className="chars">
        <p>
          <strong>Remaining: </strong> {formattedChars(chars.charsRemaining)}
        </p>
        <p>
          <strong>Found: </strong> {formattedChars(chars.charsFound)}
        </p>
      </div>
      <div id="timer">
      ...
      {won && (
        <div id="highscores">
          <Highscores imgName={imgName} won={won} score={timeElapsed} />
        </div>
      )}
    </div>
  );
